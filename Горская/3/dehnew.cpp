...
/*
 *	Метод дихотомии, или метод половинного деления, — это численный способ нахождения корней уравнения. Он основан на принципе разделения отрезка пополам и выборе подотрезка, где функция меняет знак.
 * */
